...
var _expo_prop_model: BulletBase

var bullet_velocity: int setget set_bullet_velocity, get_bullet_velocity
...
func _init(bullet_direction: Vector2, bullet_initial_position: Vector2):
	...
	self._expo_prop_model = InjectModel.get_dependency("TankBullet")

	bullet_velocity = _expo_prop_model.bullet_velocity
