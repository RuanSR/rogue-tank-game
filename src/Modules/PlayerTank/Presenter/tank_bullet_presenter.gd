...
func _init(tank_bullet_view: Area2D, bullet_direction: Vector2) -> void:
	...
	_model = preload("res://src/Modules/PlayerTank/Model/tank_bullet_model.gd").new(self._view.BulletCollisionShape2D, self._view.BulletSprite2D, self._view.BulletVisibilityNotifier2D, bullet_direction)
